...
Self-contained HTML artifacts and tools.

Add `artifacts/<slug>/index.html`, an optional `README.md`, and a line in `artifacts/index.html`. Netlify serves `artifacts/` as is, no build step.
